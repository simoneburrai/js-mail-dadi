...
//bonus
const userNumber = parseInt(prompt("Inserisci un numero da 1 a 6"));
...
// Condizione: verifico che il numero sia giusto:
NanNumber = isNaN(userNumber);
numberDiceRange = (userNumber >= minNumber && userNumber <= maxNumber);
verifiedNumber = !NanNumber && numberDiceRange;

if(!verifiedNumber){
    console.log("ERRORE: Inserisci un NUMERO compreso tra 1 e 6");
}else {
